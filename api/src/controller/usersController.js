...
const createUser = async (req, res) => {
  ...
  try {
    ...
    if (userExist) {
      return res.send({message: "El correo electronico ya existe en la base de datos"})
    }
...
const updateUser= await userSchema.findOneAndUpdate({_id:id}, { name, password, email })
